...
| Identity (v1) | `GET/POST /api/v1/identity/users`, `GET /api/v1/identity/users/{id}`, `POST /api/v1/identity/users/{id}/activate\|suspend`, `GET /api/v1/identity/organizations`, `GET/POST /api/v1/identity/departments`, `GET /api/v1/identity/roles`, `GET /api/v1/identity/sessions` (Phase 4 Part 4.1; versioned, standard error envelope, `user.view` / `user.create` gated) |
