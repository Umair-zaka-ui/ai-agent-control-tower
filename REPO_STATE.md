...
9. **Phase 5.2 cryptographic signing is unimplemented** — see §6, row 5.2.4. (Compatibility analysis, row 5.2.6, shipped in Phase 5.2.6 and is no longer a gap.)
