...
class AuthEventType(str, enum.Enum):
    ...
    # Account protection & risk-based authentication (4.2.2.3.4 §31).
    ACCOUNT_LOCKED = "ACCOUNT_LOCKED"
    ACCOUNT_UNLOCKED = "ACCOUNT_UNLOCKED"
    BRUTE_FORCE_DETECTED = "BRUTE_FORCE_DETECTED"
    CREDENTIAL_STUFFING_DETECTED = "CREDENTIAL_STUFFING_DETECTED"
    RISK_LOGIN_DETECTED = "RISK_LOGIN_DETECTED"
    LOGIN_CHALLENGE_REQUIRED = "LOGIN_CHALLENGE_REQUIRED"
    IP_BLOCKED = "IP_BLOCKED"
    IP_UNBLOCKED = "IP_UNBLOCKED"
    PROTECTION_RULE_CREATED = "PROTECTION_RULE_CREATED"
    PROTECTION_RULE_UPDATED = "PROTECTION_RULE_UPDATED"
    PROTECTION_RULE_DELETED = "PROTECTION_RULE_DELETED"
    PROTECTION_RULE_TRIGGERED = "PROTECTION_RULE_TRIGGERED"
