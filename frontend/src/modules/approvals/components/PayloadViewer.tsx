...
/** Collapsible JSON viewer with copy + download (SRS §Request Payload). */
export function PayloadViewer({ payload, defaultCollapsed = false, title = 'Request Payload' }: PayloadViewerProps) {
