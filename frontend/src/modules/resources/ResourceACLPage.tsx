...
export function ResourceACLPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-4 p-4 sm:p-6">
      <div>
        <h1 className="text-xl font-semibold text-foreground">Resource ACL</h1>
        <p className="text-sm text-muted-foreground">
          Explicit allow/deny entries per resource. Deny always wins; expired entries are ignored.
        </p>
      </div>
